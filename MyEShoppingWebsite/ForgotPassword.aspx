        ...
        <div>
         ...
         <div class="container">
             <div class="form-horizontal">
                 ...
                 <hr />
                 <h3>Please Enter Your Email Id,we will send you the recovery link for your password.</h3>
                 <div class="form-group">
                     <asp:Label ID="lblEmail" CssClass="col-md-2 control-label" runat="server" Text="Enter Your Email here"></asp:Label>
                     <div class="col-md-3">
